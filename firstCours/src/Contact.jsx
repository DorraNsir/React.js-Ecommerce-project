...
export default function Contact() {
  return (
    <section className="section section-on-footer" data-background="images/backgrounds/bg-dots.png" style={{backgroundImage: "url(images/backgrounds/bg-dots.png)"}}>
        ...
        <div className="bg-white rounded text-center p-5 shadow-down">
          ...
          <form action="#" className="row">
            ...
            <div className="col-12">
              <textarea name="message" id="message" className="form-control px-0 mb-4" placeholder="Type Message Here" required></textarea>
            </div>
